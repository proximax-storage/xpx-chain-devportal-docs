...
When talking about tokens in Sirius Chain, we are actually referring to [mosaics](../../built-in-features/mosaic.md) also known as Sirius Digital Asset - SDA. Sirius Chain enables atomic swaps through the [secret lock](../../built-in-features/cross-chain-swaps.md#secretlocktransaction) / [secret proof transaction](../../built-in-features/cross-chain-swaps.md#secretprooftransaction) mechanism.
